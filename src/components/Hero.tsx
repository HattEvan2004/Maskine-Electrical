          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            ...
            >
              <div className="flex flex-col text-left">
                <span className="font-display font-bold text-white text-lg sm:text-2xl flex items-center gap-1">100%</span>
                <span className="text-xs text-slate-500 font-sans">Licensed & Bonded</span>
              </div>
              <div className="flex flex-col text-left">
                <span className="font-display font-bold text-white text-lg sm:text-2xl flex items-center gap-1">24/7</span>
